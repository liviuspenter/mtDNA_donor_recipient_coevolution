...
protein.order <- c(
  "CD34", "CD117", "CD123", "CD38", "HLA-DR", "CD56", "CD33", "CD64", "CD14", "CD16", "CD10", "CD11b", "CD11c", "CD45", "CD71", "CD141", "CD49d",
...
ggplot(data = df, aes(x = Var2, y = 100 * Freq, fill = Var1)) +
  geom_col() +
...
DoHeatmap(so.13.Tcell,
  group.by = "manual.cluster", features = c("CD3", "CD56", "CD16", "CD4", "CD8", "CD62L", "CD45RA", "CD45RO", "CD44", "CD69"),
