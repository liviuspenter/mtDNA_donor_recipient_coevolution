...
variants.CLL2 = c('chrM:12706:T/C', 'chrM:3614:C/T', 'chrM:9541:C/T', 'chrM:2708:G/A', 'chrM:6000:T/C', 'chrM:150:T/C', 'chrM:11720:A/G', 
                  'chrM:16250:C/T')

df = data.frame(variants.CLL1 = rowMeans(vafs.1[,variants.CLL1]),
                variants.CLL2 = rowMeans(vafs.1[,variants.CLL2]))

ggplot(df, aes(x=variants.CLL1, y=variants.CLL2)) + geom_point() +
