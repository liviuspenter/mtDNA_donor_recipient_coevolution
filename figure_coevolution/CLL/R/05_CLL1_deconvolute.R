...
# recipient SNPs
variants.CLL2.recipient = c('ERICH3:chr1:75102115:G/C', 'WASF3:chr13:27255288:G/T', 'ESRRG:chr1:216880662:G/A', 'DNAJB7:chr22:41257549:A/C',
...
# deconvolute
df = data.frame(variants.CLL2.recipient = rowMeans(vafs.1[,variants.CLL2.recipient]),
