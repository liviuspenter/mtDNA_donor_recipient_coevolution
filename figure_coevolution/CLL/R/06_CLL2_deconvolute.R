...
# recipient SNPs
variants.CLL3.recipient <- c(
  "ASL:chr7:65554385:C/T", "ASL:chr7:65554352:C/T", "RELA:chr11:65429479:C/G", "B3GALT1:chr2:168726231:C/T", "ESRRG:chr1:216880662:G/A",
...
df <- data.frame(
  variants.CLL3.recipient = rowMeans(vafs.1[, variants.CLL3.recipient]),
