...
CLL.mgatk <- AlleleFreq(
  object = CLL.mgatk, variants = c(
    "3538G>A", "16247A>G", "6426G>A", "16290C>T",
...
Heatmap(t(vafs[c(cells.1, cells.recipient.2, cells.donor.2), relevant.mutations]),
...
CLL.clone1.auto <- c(
  "OPRK1:chr8:54163591:A/T", "IGLL5:chr22:23235972:G/A", "UBR4:chr1:19439249:C/T", "ICE1:chr5:5464776:C/T", "CA3:chr8:86360275:C/T",
  "NAA40:chr11:63721451:A/T", "LAMA5:chr20:60912714:C/A"
)
CLL.clone1.mito <- c("4344T>C", "13916G>A", "16247A>G")
CLL.clone2.auto <- c(
  "KCNA6:chr12:4920442:C/T", "SH3RF1:chr4:170043260:C/T", "DPCD:chr10:103354473:C/A", "ZNF215:chr11:6953628:A/C", "MGA:chr15:42019401:C/T",
...
Heatmap(
  ...
  row_split = factor(
    ...
    levels = c(
      "CLL common auto", "CLL common mito",
...
length(which(vafs[cells.1.CLL, "6426G>A"] > 25))
length(cells.1.CLL)

ggplot(data = vafs[cells.1.CLL, ], aes(x = `6426G>A`, y = `DPCD:chr10:103354473:C/A`)) +
  geom_point(color = "blue", size = 0.5) +
  scale_x_continuous("% 6426G>A", limits = c(0, 100)) +
  scale_y_continuous("% DPCDD41E", limits = c(0, 100)) +
  theme_classic() +
  theme(
    axis.text = element_text("Arial", size = 8, color = "black"),
    axis.title = element_text("Arial", size = 8, color = "black")
  )
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_pre_FCR_6426_DPCD.svg", width = 1.3, height = 1.3)

ggplot(data = vafs[cells.1.CLL, ], aes(x = `6426G>A`, y = `ZNF215:chr11:6953628:A/C`)) +
  geom_point(color = "blue", size = 0.5) +
  scale_x_continuous("% 6426G>A", limits = c(0, 100)) +
  scale_y_continuous("% ZNF215H42P", limits = c(0, 100)) +
  theme_classic() +
  theme(
    axis.text = element_text("Arial", size = 8, color = "black"),
    axis.title = element_text("Arial", size = 8, color = "black")
  )
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_pre_FCR_6426_ZNF215.svg", width = 1.3, height = 1.3)

ggplot(data = vafs[cells.1.CLL, ], aes(x = `16290C>T`, y = `DPCD:chr10:103354473:C/A`)) +
  geom_point(color = "blue", size = 0.5) +
  scale_x_continuous("% 16290C>T", limits = c(0, 100)) +
  scale_y_continuous("% DPCDD41E", limits = c(0, 100)) +
  theme_classic() +
  theme(
    axis.text = element_text("Arial", size = 8, color = "black"),
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_pre_FCR_16290_DPCD.svg", width = 1.3, height = 1.3)

ggplot(data = vafs[cells.1.CLL, ], aes(x = `16290C>T`, y = `ZNF215:chr11:6953628:A/C`)) +
  geom_point(color = "blue", size = 0.5) +
  scale_x_continuous("% 16290C>T", limits = c(0, 100)) +
  scale_y_continuous("% ZNF215H42P", limits = c(0, 100)) +
  theme_classic() +
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_pre_FCR_16290_ZNF215.svg", width = 1.3, height = 1.3)




ggplot(data = vafs[cells.2.recipient, ], aes(x = `6426G>A`, y = `DPCD:chr10:103354473:C/A`)) +
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_post_HSCT_6426_DPCD.svg", width = 1.3, height = 1.3)

ggplot(data = vafs[cells.2.recipient, ], aes(x = `6426G>A`, y = `ZNF215:chr11:6953628:A/C`)) +
  geom_point(color = "firebrick", size = 0.5) +
  scale_x_continuous("% 6426G>A", limits = c(0, 100)) +
  scale_y_continuous("% ZNF215H42P", limits = c(0, 100)) +
  theme_classic() +
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_post_HSCT_6426_ZNF215.svg", width = 1.3, height = 1.3)

ggplot(data = vafs[cells.2.recipient, ], aes(x = `16290C>T`, y = `DPCD:chr10:103354473:C/A`)) +
  geom_point(color = "firebrick", size = 0.5) +
  scale_x_continuous("% 16290C>T", limits = c(0, 100)) +
  scale_y_continuous("% DPCDD41E", limits = c(0, 100)) +
  theme_classic() +
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_post_HSCT_16290_ZNF215.svg", width = 1.3, height = 1.3)

ggplot(data = vafs[cells.2.recipient, ], aes(x = `16290C>T`, y = `ZNF215:chr11:6953628:A/C`)) +
  geom_point(color = "firebrick", size = 0.5) +
  scale_x_continuous("% 16290C>T", limits = c(0, 100)) +
  scale_y_continuous("% ZNF215H42P", limits = c(0, 100)) +
  theme_classic() +
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240104_CLL4_post_HSCT_16290_DPCD.svg", width = 1.3, height = 1.3)
...
# focus on 786G>A, 1918G>A, 5650G>A
boo <- cbind(
  vafs[c(cells.1.CLL, cells.2.recipient, cells.1.immune, cells.2.donor), ],
  data.frame(annotation = c(
    rep("CLL", length(cells.1.CLL)),
    rep("CLL", length(cells.2.recipient)),
    rep("recipient.immune", length(cells.1.immune)),
    rep("donor", length(cells.2.donor))
  ))
)
boo$celltype <- so.12$manual.cluster[rownames(boo)]

ggplot(boo, aes(x = annotation, y = `786G>A`)) +
  geom_violin() +
  ggrastr::rasterize(geom_jitter(size = 0.5, aes(color = celltype)), dpi = 600) +
  scale_x_discrete(labels = c("CLL", "donor\nimmune", "recipient\nimmune")) +
  scale_color_manual(values = c(
    "CLL" = "orange", "CD4 T cell" = "lightblue", "CD8 T cell" = "darkblue", "NK" = "purple", "Myeloid" = "darkgreen",
    "Cluster 6" = "orange"
  )) +
  scale_y_continuous("% 786G>A") +
  theme_classic() +
  theme(
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240529_distribution_786G>A.svg", width = 1.8, height = 2)

ggplot(boo, aes(x = annotation, y = `1918G>A`)) +
  geom_violin() +
  ggrastr::rasterize(geom_jitter(size = 0.5, aes(color = celltype)), dpi = 600) +
  scale_x_discrete(labels = c("CLL", "donor\nimmune", "recipient\nimmune")) +
  scale_color_manual(values = c(
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240529_distribution_1918G>A.svg", width = 1.8, height = 2)

ggplot(boo, aes(x = annotation, y = `5650G>A`)) +
  geom_violin() +
  ggrastr::rasterize(geom_jitter(size = 0.5, aes(color = celltype)), dpi = 600) +
  scale_x_discrete(labels = c("CLL", "donor\nimmune", "recipient\nimmune")) +
  scale_color_manual(values = c(
...
ggsave("./figure_coevolution/CLL/figures/CLL4/plots/20240529_distribution_5650G>A.svg", width = 1.8, height = 2)
