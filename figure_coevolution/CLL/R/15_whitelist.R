...
mutations.1.bed = data.frame(chr = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,1],
                                   stringr::str_split_fixed(colnames(vafs)[which(!startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=4)[,2]),
                           start = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,2],
                                     stringr::str_split_fixed(colnames(vafs)[which(!startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=4)[,3]),
                           stop = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,2],
                                    stringr::str_split_fixed(colnames(vafs)[which(!startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=4)[,3]))
...
mutations.2.bed = data.frame(chr = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,1],
                                     stringr::str_split_fixed(colnames(vafs)[which(!startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=4)[,2]),
                             start = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,2],
                                       stringr::str_split_fixed(colnames(vafs)[which(!startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=4)[,3]),
                             stop = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,2],
...
mutations.3.bed = data.frame(chr = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,1],
                                     stringr::str_split_fixed(colnames(vafs)[which(!startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=4)[,2]),
                             start = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,2],
                                       stringr::str_split_fixed(colnames(vafs)[which(!startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=4)[,3]),
                             stop = c(stringr::str_split_fixed(colnames(vafs)[which(startsWith(colnames(vafs), 'chr'))], pattern = '\\:', n=3)[,2],
