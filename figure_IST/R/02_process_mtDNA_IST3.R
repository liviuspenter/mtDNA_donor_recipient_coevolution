# process mgatk output and perform variant calling on mtDNA mutatios for samples for patient IST3
# samples: IST4_1, IST4_2
...
samples = c('IST4_1','IST4_2')
atac.paths = c('./data/IST/IST4_1/',
               './data/IST/IST4_2/')
mgatk.paths = c('./data/IST/IST4_1.mgatk/',
                './data/IST/IST4_2.mgatk/')
...
ggsave(filename = paste0('./figure_IST/figures/qc/20220110_IST4_strand_concordance_vmr.png'), plot = p, 
       width = 4, height = 4)
...
write.table(high.conf, file = './data/IST/mtDNA/20220110_IST4_high_confidence_variants.csv', sep = '\t', row.names = F, quote = F)
...
saveRDS(combined.mutation.frequencies, file = './data/IST/mtDNA/20220110_IST4_combined_mutation_frequencies.rds')
