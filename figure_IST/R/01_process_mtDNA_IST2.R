# process mgatk output and perform variant calling on mtDNA mutatios for samples for patient IST2
# samples: IST3_1, IST3_2
...
samples = c('IST3_1','IST3_2')
atac.paths = c('./data/IST/IST3_1/',
               './data/IST/IST3_2/')
mgatk.paths = c('./data/IST/IST3_1.mgatk/',
                './data/IST/IST3_2.mgatk/')
...
ggsave(filename = paste0('./figure_IST/figures/qc/20220110_IST3_strand_concordance_vmr.png'), plot = p, 
       width = 4, height = 4)
...
write.table(high.conf, file = './data/IST/mtDNA/20220110_IST3_high_confidence_variants.csv', sep = '\t', row.names = F, quote = F)
...
saveRDS(combined.mutation.frequencies, file = './data/IST/mtDNA/20220110_IST3_combined_mutation_frequencies.rds')
