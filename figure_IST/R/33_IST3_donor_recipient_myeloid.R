# comparison of donor- and recipient derived myeloid cells in peripheral blood of patient IST3 (samples IST4_1, IST4_2)
...
donor.cells = rownames(IST.asap.mito)[which(IST.asap.mito$Sample == 'IST4_1' & IST.asap.mito$manual.cluster == 'Myeloid' & IST.asap.mito$individual == 'donor')]
recipient.cells = rownames(IST.asap.mito)[which(IST.asap.mito$Sample == 'IST4_1' & IST.asap.mito$manual.cluster == 'Myeloid' & IST.asap.mito$individual == 'recipient')]

donor.cells.2 = rownames(IST.asap.mito)[which(IST.asap.mito$Sample == 'IST4_2' & IST.asap.mito$manual.cluster == 'Myeloid' & IST.asap.mito$individual == 'donor')]
recipient.cells.2 = rownames(IST.asap.mito)[which(IST.asap.mito$Sample == 'IST4_2' & IST.asap.mito$manual.cluster == 'Myeloid' & IST.asap.mito$individual == 'recipient')]
...
ggsave('./figure_IST/figures/IST3/plots/20230419_CD33_donor_recipient.svg', width = 1.3, height = 2.5)
...
VlnPlot(subset(TSB.so, group %in% c('donor', 'recipient', 'donor.2')), 
  ...
  theme(axis.text = element_text('Arial', size=8, color='black'),
        ...
        axis.title.x = element_blank(),
        plot.title = element_text('Arial', size=8, color='black'))
ggsave('./figure_IST/figures/IST3/plots/20230419_CD16_donor_recipient.svg', width = 1.3, height = 2.5)
...
VlnPlot(subset(TSB.so, group %in% c('donor', 'recipient', 'donor.2')), 
  ...
  theme(axis.text = element_text('Arial', size=8, color='black'),
        ...
        axis.title.x = element_blank(),
        plot.title = element_text('Arial', size=8, color='black'))
ggsave('./figure_IST/figures/IST3/plots/20230419_CD14_donor_recipient.svg', width = 1.3, height = 2.5)

# differential protein expression
# recipient has more CD14 and CD33
...
TSB.heatmap = Heatmap(protein.mat[c('CD117','CD38','CD33','CD14','CD16'), 
