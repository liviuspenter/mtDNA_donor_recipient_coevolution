# process mgatk output and perform variant calling on mtDNA mutatios for samples for patient IST4
# samples: IST5_1, IST5_2
...
samples = c('IST5_1','IST5_2')
atac.paths = c('./data/IST/IST5_1/',
               './data/IST/IST5_2/')
mgatk.paths = c('./data/IST/IST5_1.mgatk/',
                './data/IST/IST5_2.mgatk/')
...
ggsave(filename = paste0('./figure_IST/figures/qc/20220110_IST5_strand_concordance_vmr.png'), plot = p, 
       width = 4, height = 4)
...
write.table(high.conf, file = './data/IST/mtDNA/20220110_IST5_high_confidence_variants.csv', sep = '\t', row.names = F, quote = F)
...
saveRDS(combined.mutation.frequencies, file = './data/IST/mtDNA/20220110_IST5_combined_mutation_frequencies.rds')
