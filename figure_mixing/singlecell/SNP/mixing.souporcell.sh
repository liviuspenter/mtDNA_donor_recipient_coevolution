...
singularity exec $SOUPORCELL_CONTAINER souporcell_pipeline.py -i $1/merge.bam -b $1/barcodes.tsv -f $GRCH38_REF -t 12 -o $1/mixing_${1}.souporcell -k 2 --common_variants $SNP_REF --skip_remap SKIP_REMAP
