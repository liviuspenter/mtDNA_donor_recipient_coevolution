# celltype dynamics within AML1012 over time
...
AML.1012.mito$manual.clusters[which(AML.1012.mito$Clusters %in% c('C4','C7'))] = c('erythroid')
AML.1012.mito$manual.clusters[which(AML.1012.mito$Clusters %in% c('C5'))] = c('HSCT')
AML.1012.mito$manual.clusters[which(AML.1012.mito$Clusters %in% c('C2', 'C6'))] = c('GMP')
AML.1012.mito$manual.clusters[which(AML.1012.mito$Clusters %in% c('C3'))] = c('Mono')
...
plotPDF(ArchRProj = AML.1012.mito, name = 'manual.clusters.2', plotList = list(p), addDOC = F)

combined.frequencies = readRDS('./data/10026/mtDNA/20210429_AML1012_combined_mutation_frequencies.rds')
...
svglite::svglite('./figure_10026/figures/heatmaps/20210611_AML1012_myeloid_mtDNA.svg', width = 4, height = 4.5)
...
svglite::svglite('./figure_10026/figures/heatmaps/20210611_AML1012_myeloid_mtDNA2.2.svg', width = 4, height = 4.5)
ComplexHeatmap::Heatmap(as.matrix(combined.frequencies[,cells.ordered]), 
...
svglite::svglite('./figure_10026/figures/heatmaps/20210611_AML1012_myeloid_ADT.svg', width = 4, height = 2)
...
ggsave('./figure_10026/figures/plots/20210611_AML1012_cluster_kinetics.svg', width = 1.2, height = 2)
...
col_fun = circlize::colorRamp2(seq(0.0001, 0.01, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figure_10026/figures/heatmaps/20210612_AML1012_HSCT_mtDNA_kinetics.svg', width = 2, height = 3)
...
col_fun = circlize::colorRamp2(seq(0.0001, 0.01, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figure_10026/figures/heatmaps/20210612_AML1012_GMP_mtDNA_kinetics.svg', width = 2, height = 3)
...
Mono1.1 = AML.1012.mito$cellNames[which(AML.1012.mito$manual.clusters == 'Mono' & AML.1012.mito$Sample.hash == 'AML1012_1')]
Mono1.2 = AML.1012.mito$cellNames[which(AML.1012.mito$manual.clusters == 'Mono' & AML.1012.mito$Sample.hash == 'AML1012_2')]
Mono1.4 = AML.1012.mito$cellNames[which(AML.1012.mito$manual.clusters == 'Mono' & AML.1012.mito$Sample.hash == 'AML1012_4')]
...
col_fun = circlize::colorRamp2(seq(0.0001, 0.01, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figure_10026/figures/heatmaps/20210612_AML1012_Mono_mtDNA_kinetics.svg', width = 2, height = 3)
...
col_fun = circlize::colorRamp2(seq(0.0001, 0.01, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figure_10026/figures/heatmaps/20210612_AML1012_Ery_mtDNA_kinetics.svg', width = 2, height = 3)
