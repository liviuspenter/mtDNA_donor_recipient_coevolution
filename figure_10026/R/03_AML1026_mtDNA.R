# process mgatk output of AML1026
...
atac.paths = c('./data/10026/AML1026_12/',
               './data/10026/AML1026_34/')
mgatk.paths = c('./data/10026/AML1026_12.mgatk/',
                './data/10026/AML1026_34.mgatk/')
...
ggsave(filename = paste0('./figure_10026/figures/qc/20210429_AML1026_strand_concordance_vmr.png'), plot = p, 
       width = 4, height = 4)
...
write.table(high.conf, file = './data/10026/mtDNA/20210429_AML1026_high_confidence_variants.csv', sep = '\t', row.names = F, quote = F)
...
saveRDS(combined.mutation.frequencies, file = './data/10026/mtDNA/20210429_AML1026_combined_mutation_frequencies.rds')
