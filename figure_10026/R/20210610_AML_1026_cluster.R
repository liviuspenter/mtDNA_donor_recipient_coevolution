...
combined.frequencies = readRDS('./data/mtDNA/20210429_AML1026_combined_mutation_frequencies.rds')
...
svglite::svglite('./figures/heatmaps/20210611_AML1026_myeloid_mtDNA.svg', width = 4, height = 4.5)
...
svglite::svglite('./figures/heatmaps/20210611_AML1026_myeloid_ADT.svg', width = 4, height = 2)
...
ggsave('./figures/plots/20210611_AML1026_cluster_kinetics.svg', width = 1.3, height = 2)
...
col_fun = circlize::colorRamp2(seq(0.001, 0.1, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figures/heatmaps/20210612_AML1026_HSCT_mtDNA_kinetics.svg', width = 2, height = 2.5)
...
col_fun = circlize::colorRamp2(seq(0.001, 0.1, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figures/heatmaps/20210612_AML1026_GMP_mtDNA_kinetics.svg', width = 2, height = 2.5)
...
col_fun = circlize::colorRamp2(seq(0.001, 0.1, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figures/heatmaps/20210612_AML1026_Mono_mtDNA_kinetics.svg', width = 2, height = 2.5)
...
col_fun = circlize::colorRamp2(seq(0.001, 0.1, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figures/heatmaps/20210612_AML1026_Ery_mtDNA_kinetics.svg', width = 2, height = 2.5)
...
svglite::svglite('./figures/heatmaps/20210624_AML1026_myeloid_mtDNA_recipient_donor_variants.svg', width = 4, height = 4.5)
ComplexHeatmap::Heatmap(as.matrix(combined.frequencies[,cells.ordered]), 
                        show_row_dend = F, show_column_dend = F, cluster_columns = F, cluster_rows = F,
                        show_column_names = F, show_row_names = T, show_heatmap_legend = F, 
