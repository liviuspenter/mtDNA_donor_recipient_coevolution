...
chimerism.corr = readxl::read_excel('./data/mtDNA/20210712_correlation_chimerism.xlsx')

cor.test(chimerism.corr$Clinical.chimerism, chimerism.corr$mtDNA.chimerism)

ggsave('./figures/plots/20211107_correlation_chimerism.svg', width = 2, height = 2)
