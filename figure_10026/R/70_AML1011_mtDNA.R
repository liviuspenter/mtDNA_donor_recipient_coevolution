...
samples <- c("AML1011_A", "AML1011_B", "AML1011_1", "AML1011_2")
atac.paths <- c(
  "./data/10026/Pool148_13/",
  "./data/10026/Pool148_14/",
  "./data/10026/Pool148_15/",
  "./data/10026/Pool148_16/"
)
mgatk.paths <- c(
  "./data/10026/Pool148_13.mgatk/final/",
  "./data/10026/Pool148_14.mgatk/final/",
  "./data/10026/Pool148_15.mgatk/final/",
  "./data/10026/Pool148_16.mgatk/final/"
)
...
ggsave(
  filename = paste0("./figure_10026/figures/qc/20240516_AML1011_strand_concordance_vmr.png"), plot = p,
  width = 4, height = 4
)
...
write.table(high.conf, file = "./data/10026/mtDNA/20240516_AML1011_high_confidence_variants.csv", sep = "\t", row.names = F, quote = F)
...
saveRDS(combined.mutation.frequencies, file = "./data/10026/mtDNA/20240516_AML1011_combined_mutation_frequencies.rds")
