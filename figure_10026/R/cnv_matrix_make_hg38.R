# helper functions for calculating CNVs from scATAC-seq profiles
# taken and modified from Caleb Lareau's github repository
...
# Setup cnv blocks
sizes <- read.table("./data/10026/cnv_cl/chrom_hg38.sizes", stringsAsFactors = FALSE)
...
make_basic_mat <- function(frag_file, barcodes){
  ...
  # Remove blacklist
  bl <- diffloop::bedToGRanges("./data/10026/cnv_cl/hg38.full.blacklist.bed")
  ...
  regions_pbmc10k <- readRDS("./data/10026/cnv_cl/vector_of_regions_hg38.rds")
