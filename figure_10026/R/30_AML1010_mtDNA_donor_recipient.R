# perform mtDNA-based donor-recipient deconvolution for AML1010
...
ggsave(paste0('./figure_10026/figures/deconvolution/20220302_AML1010_mtDNA_variants.svg'), width = 1.5, height = 1.5, plot = p)
...
ggsave('./figure_10026/figures/umaps/20211107_AML1010_donor_derived_cells.png', width = 2.5, height = 2.5)
...
write.csv2(chimerism.df, file = './data/10026/mtDNA/20200302_AML1010_donor_recipient.csv')
