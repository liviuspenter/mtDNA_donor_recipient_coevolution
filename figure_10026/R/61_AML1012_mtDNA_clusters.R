# discovery and tracking of AML subclones defined by mtDNA mutations in AML1012
...
ggsave('./figure_10026/figures/heatmaps/20220304_AML1012_mtDNA_clusters.svg', width = 3, height = 2.5)
ggsave('./figure_10026/figures/heatmaps/20220304_AML1012_mtDNA_clusters.png', width = 2, height = 2)
...
for (s in c('AML1012_1', 'AML1012_2', 'AML1012_3', 'AML1012_4')) {
  ...
  ggsave(paste0('./figure_10026/figures/plots/AML1012/20230331_mito_cluster_dynamics_', s, '.svg'), width=1.3, height = 2, plot = p)
}
...
for (s in c('AML1012_1', 'AML1012_2', 'AML1012_3', 'AML1012_4')) {
  p=ggplot(df[which(df$sample == s),], aes(x=UMAP1, y=UMAP2, color=mito.cluster)) + geom_point(size=0.5) + 
    ...
    theme_classic() +
    NoAxes() + NoLegend()
  ggsave(paste0('./figure_10026/figures/umaps/AML1012/20230331_',s,'_UMAP_mitoclusters.png'), width = 3, height = 3, dpi = 600, plot = p)
}
...
ggplot(boo[which(!boo$Var2 %in% c('none', 'AML1012_3')),], 
  ...
  theme(legend.position = 'none', 
        ...
        axis.text = element_text('Arial', size=10, color='black'))
ggsave('./figure_10026/figures/plots/20220303_AML1012_mtDNA_clusters.svg', width = 1.1, height = 2)

DimPlot(mtDNA.so) +
  scale_color_manual(values = AML.1012.cluster.colors) + 
  NoAxes() + NoLegend()
ggsave('./figure_10026/figures/umaps/20220304_AML1012_mtDNA_clusters.png', width = 3, height = 3, dpi = 600)

saveRDS(mtDNA.so, file = './data/objects/20220303_AML1012_mtDNA.so.rds')
