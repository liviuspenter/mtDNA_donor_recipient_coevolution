...
samples <- c("AML1012_12", "AML1012_34", "AML1012_A")
atac.paths <- c(
  "./data/10026/AML1012_12/",
  "./data/10026/AML1012_34/",
  "./data/10026/Pool148_17/"
)
mgatk.paths <- c(
  "./data/10026/AML1012_12.mgatk/",
  "./data/10026/AML1012_34.mgatk/",
  "./data/10026/Pool148_17.mgatk/final/"
)
...
ggsave(
  filename = paste0("./figure_10026/figures/qc/20240516_AML1012_strand_concordance_vmr.png"), plot = p,
  width = 4, height = 4
)
...
write.table(high.conf, file = "./data/10026/mtDNA/20240516_AML1012_high_confidence_variants.csv", sep = "\t", row.names = F, quote = F)
...
saveRDS(combined.mutation.frequencies, file = "./data/10026/mtDNA/20240516_AML1012_combined_mutation_frequencies.rds")
