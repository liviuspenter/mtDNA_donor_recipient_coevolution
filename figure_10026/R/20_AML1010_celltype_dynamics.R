# celltype dynamics within AML1010 over time
...
combined.frequencies = readRDS('./data/10026/mtDNA/20210429_AML1010_combined_mutation_frequencies.rds')
...
svglite::svglite('./figure_10026/figures/heatmaps/20210611_AML1010_myeloid_mtDNA.svg', width = 4, height = 4.5)
...
svglite::svglite('./figure_10026/figures/heatmaps/20210611_AML1010_myeloid_mtDNA2.svg', width = 4, height = 4.5)
ComplexHeatmap::Heatmap(as.matrix(combined.frequencies[,cells.ordered]), 
...
svglite::svglite('./figure_10026/figures/heatmaps/20210611_AML1010_myeloid_ADT.svg', width = 4, height = 2)
...
ggsave('./figure_10026/figures/plots/20210611_AML1010_cluster_kinetics.svg', width = 1.5, height = 2)
...
col_fun = circlize::colorRamp2(seq(0.001, 0.1, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figure_10026/figures/heatmaps/20210612_AML1010_HSCT_mtDNA_kinetics.svg', width = 2, height = 2.5)
...
col_fun = circlize::colorRamp2(seq(0.001, 0.1, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figure_10026/figures/heatmaps/20210612_AML1010_GMP_mtDNA_kinetics.svg', width = 2, height = 2.5)
...
col_fun = circlize::colorRamp2(seq(0.001, 0.1, length=100), colorRampPalette(BuenColors::jdb_palette(name = 'solar_rojos', n=9))(100))
svglite::svglite('./figure_10026/figures/heatmaps/20210612_AML1010_Ery_mtDNA_kinetics.svg', width = 2, height = 2.5)
...
svglite::svglite('./figure_10026/figures/heatmaps/20210624_AML1010_myeloid_mtDNA_recipient_donor_variants.svg', width = 4, height = 4.5)
ComplexHeatmap::Heatmap(as.matrix(combined.frequencies[,cells.ordered]), 
                        show_row_dend = F, show_column_dend = F, cluster_columns = F, cluster_rows = F,
                        show_column_names = F, show_row_names = T, show_heatmap_legend = F, 
                        row_title = '28 mtDNA mutations', row_title_gp = gpar(fontsize=10, color='black'),
