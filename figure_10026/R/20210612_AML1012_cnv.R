...
mat = make_basic_mat('./data/AML1012_12/fragments.tsv.gz', bcs)
saveRDS(mat, file = './data/objects/20210612_AML1012_12_cnv.rds')
...
saveRDS(mat, file = './data/objects/20210612_AML1012_34_cnv.rds')
...
for (s in c('AML1012_1', 'AML1012_2', 'AML1012_4')) {
  if (s %in% c('AML1012_1','AML1012_2')) {
    mat = readRDS('./data/objects/20210612_AML1012_12_cnv.rds')
  } else {
    mat = readRDS('./data/objects/20210612_AML1012_34_cnv.rds')
  }
...
ggsave('./figures/plots/20220302_AML1012_CNV_plot.svg', width = 2, height = 2)
...
ggsave('./figures/umaps/20220301_AML1012_CNV_cells.png', width = 2.5, height = 2.5)
...
ggsave('./figures/plots/20220302_AML1012_CNV_longitudinal.svg', width = 1, height = 2)
