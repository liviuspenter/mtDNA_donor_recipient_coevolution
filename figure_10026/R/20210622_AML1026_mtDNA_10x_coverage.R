...
samples = c('AML1026_12','AML1026_34')
atac.paths = c('/Users/shaka87/dfci/asap_seq/data/AML1026_12/',
               '/Users/shaka87/dfci/asap_seq/data/AML1026_34/')
mgatk.paths = c('/Users/shaka87/dfci/asap_seq/data/AML1026_12.mgatk/',
                '/Users/shaka87/dfci/asap_seq/data/AML1026_34.mgatk/')
...
ggsave(filename = paste0('./figures/qc/20210622_AML1026_strand_concordance_vmr.png'), plot = p, 
       width = 4, height = 4)
...
write.table(high.conf, file = './data/mtDNA/20210622_AML1026_high_confidence_variants.csv', sep = '\t', row.names = F, quote = F)
...
saveRDS(combined.mutation.frequencies, file = './data/mtDNA/20210622_AML1026_combined_mutation_frequencies.rds')
