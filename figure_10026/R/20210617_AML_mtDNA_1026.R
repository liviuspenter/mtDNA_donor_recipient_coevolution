...
ggsave(paste0('./figures/deconvolution/20220302_AML1026_mtDNA_variants.svg'), width = 1.5, height = 1.5, plot = p)
...
ggsave('./figures/umaps/20211107_AML1026_donor_derived_cells.png', width = 2.5, height = 2.5)
...
write.csv2(chimerism.df, file = './data/mtDNA/20200302_AML1026_donor_recipient.csv')
