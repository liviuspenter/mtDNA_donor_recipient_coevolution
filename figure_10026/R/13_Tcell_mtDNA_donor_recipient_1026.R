# donor-recipient deconvolution of T cells in AML1026
...
svglite::svglite('./figure_10026/figures/heatmaps/20210607_AML1026_mtDNA.svg', width = 4, height = 4.5)
...
svglite::svglite('./figure_10026/figures/heatmaps/20210607_AML1026_mtDNA.2.svg', width = 3, height = 3)
ComplexHeatmap::Heatmap(as.matrix(combined.frequencies[c(donor.variants, recipient.variants),cells.ordered]), 
                        show_row_dend = F, show_column_dend = F, cluster_columns = F, cluster_rows = F,
...
ggsave('./figure_10026/figures/plots/20210610_1026_donor_recipient.svg', width = 2.5, height = 2.5)
