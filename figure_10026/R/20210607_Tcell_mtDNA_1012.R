...
svglite::svglite('./figures/heatmaps/20210607_AML1012_mtDNA.svg', width = 3, height = 3)
...
saveRDS(file='./data/objects/20211107_cluster_information_AML1012_Tcell.rds', cluster.information)