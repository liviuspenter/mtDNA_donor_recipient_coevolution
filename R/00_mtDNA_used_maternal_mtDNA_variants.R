# plot maternal mtDNA variants used for donor-recipient deconvolution of single cell data
...
germline.variants = read.csv2('./data/IST/objects/20220117_IST_germline_variants.csv')
germline.variants = rbind(germline.variants, read.csv2('./data/10026/mtDNA/20220117_AML_germline_variants.csv'))
...
ggsave('./figure_10026/figures/plots/20220119_mtDNA_germline_variants.svg', width = 3.5, height = 2.5)