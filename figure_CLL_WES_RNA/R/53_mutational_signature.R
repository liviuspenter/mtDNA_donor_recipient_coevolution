...
mutational.signature <- get_enrich_mutation_df(results.df$variant[which(results.df$heteroplasmy < 0.005)], ref_all)
...
ggsave("./figure_CLL_WES_RNA/figures/CRC/20231128_mutation_signature_not_filtered.svg", width = 4, height = 2)
...
ggsave("./figure_CLL_WES_RNA/figures/CRC/20231128_mutation_signature_filtered.svg", width = 4, height = 2)
